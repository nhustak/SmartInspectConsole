...
rem SmartInspectConsole install from CC3 production package folder (g)
rem Run from the FTP package directory that contains si-g.zip

set "ERR=0"
set "ENV_NAME=g"
set "SOURCE_ARCHIVE=%~dp0si-g.zip"
set "TARGET_ROOT=C:\Tools\SmartInspectConsole"
set "STAGE_DIR=%TARGET_ROOT%\current"
set "LOG_FILE=%~dp0deploy-si-g.log"

echo ========================================
echo SmartInspectConsole install (%ENV_NAME% / CC3-Prod)
