...
public sealed class BatchDiagnosticsSnapshot
{
    ...
    public override string ToString()
        => $"Queues L:{LogQueueDepth:N0} W:{WatchQueueDepth:N0} P:{ProcessFlowQueueDepth:N0} | Batch {LastBatchSize:N0} in {LastBatchDurationMs:F1} ms | Rendered {TotalLogEntriesRendered:N0}/{TotalLogEntriesReceived:N0}";
}
